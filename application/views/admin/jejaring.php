            ...
            <div class="col-4 text-end d-flex align-content-center align-items-center justify-content-center">
              <select class="form-control form-control-alternative me-3" id="sortBulanAgenda">
                  ...
                  <option value="3">Offtaker Pangan Segar/Olahan</option>
							...
							<a class="btn bg-gradient-dark mb-0 d-flex justify-content-center align-content-center align-items-center" href="#">
                    ...
                    <p class="small text-xs text-secondary mb-0">Petani/Produsen Pangan Segar</p>
									...
									<td class="align-top">
										<div class="ms-auto text-center">
											<a class="btn btn-link btn-sm py-0 text-info px-2 mb-0"
												href="http://localhost/tax-session/pelatihan/tax-session" target="__BLANK"><i class="far fa-eye"
													aria-hidden="true"></i></a>
											<button type="button" class="btn btn-link btn-sm py-0 text-danger px-2 mb-0 btn-remove"
												data-id="5"><i class="far fa-trash-alt" aria-hidden="true"></i></button>
											<a class="btn btn-link btn-sm py-0 text-dark px-2 mb-0"
												href="http://localhost/tax-session/admin/pelatihan/edit/5"><i class="fas fa-pencil-alt"
													aria-hidden="true"></i></a>
										</div>
									</td>
								</tr>
