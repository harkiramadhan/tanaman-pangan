					...
					<div class="row">
						...
						<div class="col-4 text-end d-flex align-content-center align-items-center justify-content-end">
							<button class="btn bg-gradient-dark mb-0 d-flex justify-content-center align-content-center align-items-center"  data-bs-toggle="modal" data-bs-target="#modalTambahTestimoni">
								...
								<span class="d-lg-inline d-none">Kegiatan</span>
							</button>
						</div>
					</div>
				</div>
						...
						<table class="table align-items-center mb-0 display" id="example" style="width:100%">
							<thead class="bg-light opacity-5">
								<tr>
									...
									<th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-10">Kegiatan</th>
										...
										<tr>
											...
											<td>
												<div class="d-flex px-2 py-1">
													<div>
														<img src="<?= base_url('uploads/kegiatan/' . $row->img) ?>" class="avatar avatar-sm me-3" alt="user1">
													</div>
													<div class="d-flex flex-column justify-content-center">
														<h6 class="mb-0 text-sm"><?= $row->judul ?></h6>
														<p class="small text-xs text-secondary mb-0"><?= longdate_indo($row->tanggal) ?></p>
													</div>
												</div>
											</td>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="modalTambahTestimoni">Tambah Kegiatan</h1>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form action="<?= site_url('admin/kegiatan/create') ?>" enctype="multipart/form-data" method="POST">
						...
						<div class="row d-flex align-items-center form-group">
							...
							<div class="col-md-8">
								<input type="text" name="judul" class="form-control font-weight-bold text-muted" required>
							</div>
						</div>
						<div class="row d-flex align-items-center form-group mt-2">
							...
							<div class="col-md-8">
								<input type="date" name="tanggal" class="form-control font-weight-bold text-muted" required>
							</div>
						</div>
						<div class="row d-flex align-items-center form-group mt-2">
							<div class="col-md-4">
							...
							<div class="col-md-8">
								<input type="text" name="link" class="form-control font-weight-bold text-muted" required>
							</div>
						</div>
						<div class="row d-flex align-items-center form-group">
							<div class="col-md-4">
