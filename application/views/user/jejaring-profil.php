            ...
            <div class="d-flex align-items-center py-3">
               <div class="profile-left">
                  <ol class="breadcrumb bg-white px-0 py-0 mb-3">
                     <li class="breadcrumb-item small"><a href="<?= site_url('') ?>" class="text-info"><i class="fa fa-home mr-2"></i><?= ($this->session->userdata('lang') == 'EN') ? 'Home' : 'Beranda' ?></a></li>
                     <li class="breadcrumb-item small"><a href="<?= site_url('jejaring') ?>" class="text-info"><?= ($this->session->userdata('lang') == 'EN') ? 'Network' : 'Jejaring' ?></a></li>
               ...
               <div class="profile-right ml-auto">
                  ...
                  <a href="https://api.whatsapp.com/send/?phone=<?= $jejaring->hp ?>&text&type=phone_number&app_absent=0" class="btn btn-success text-white" target="__BLANK"> &nbsp; <i class="fa fa-whatsapp fa-lg mr-1" aria-hidden="true"></i> <?= ($this->session->userdata('lang') == 'EN') ? 'Contact Now' : 'Hubungi Sekarang' ?> &nbsp; </a>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="row">
         ...
         <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
            <div class="box shadow-sm rounded bg-white mb-3">
               <div class="box-title border-bottom p-3">
                  <h6 class="m-0 font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'About Us' : 'Tentang Kami' ?></h6>
               </div>
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               <div class="box-title border-bottom p-3">
                  <h6 class="m-0 font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'Complete Profile' : 'Biodata Lengkap' ?></h6>
               </div>
               <div class="box-body">
                  <table class="table table-borderless mb-0">
                     <tbody>
                        <tr class="border-bottom">
                           <th class="p-3" width="40%;"><?= ($this->session->userdata('lang') == 'EN') ? 'Institution' : 'Lembaga' ?></th>
                           <td class="p-3"><?= $jejaring->nama_kelembagaan ?></td>
                        </tr>
                        <tr class="border-bottom">
                           <th class="p-3" width="40%;"><?= ($this->session->userdata('lang') == 'EN') ? 'Institution Category' : 'Kategori Lembaga' ?></th>
                           <td class="p-3"><?= $jejaring->kelembagaan ?></td>
                        </tr>
                        <tr class="border-bottom">
                           <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Phone number' : 'No HP' ?></th>
                           <td class="p-3"><?= $jejaring->hp ?></td>
                        </tr>
                        <tr class="border-bottom">
                           <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Address' : 'Alamat' ?></th>
                           <td class="p-3"><?= $jejaring->alamat ?></td>
                        </tr>
                        <tr class="border-bottom">
                           <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Name of the Person in Charge' : 'Nama PJ' ?></th>
                           <td class="p-3"><?= $jejaring->nama ?></td>
                        </tr>
                        <tr class="border-bottom">
                           <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Commodity' : 'Komoditas' ?></th>
                           <td class="p-3"><?php 
                              if($komoditas->num_rows() > 0):
                                 $copy = $komoditas->result();
                                 foreach($komoditas->result() as $k){
                                    echo ($this->session->userdata('lang') == 'EN') ? $k->komoditas_en : $k->komoditas;
                                    if(next($copy)){
                                       echo ", ";
                                    }
                                 }
                        ...
                        <?php if($jejaring->lahan_yg_dikelola): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Area' : 'Lahan' ?></th>
                              <td class="p-3"><?= ($jejaring->lahan_yg_dikelola) ? $jejaring->lahan_yg_dikelola : ' - ' ?> <?= ($this->session->userdata('lang') == 'EN') ? 'Hectare' : 'Hektar' ?></td>
                           </tr>
                        <?php endif; ?>
                        
                        <?php if($jejaring->rata_produksi_tahun): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Production' : 'Produksi' ?></th>
                              <td class="p-3"><?= ($jejaring->rata_produksi_tahun) ? $jejaring->rata_produksi_tahun : ' - ' ?> Kg <sup class="text-danger">/<?= ($this->session->userdata('lang') == 'EN') ? 'Year' : 'Tahun' ?></sup></td>
                           </tr>
                        <?php endif; ?>
                        
                        <?php if($jejaring->rata_produksi_bulan): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Needs' : 'Kebutuhan' ?></th>
                              <td class="p-3"><?= ($jejaring->rata_produksi_bulan) ? $jejaring->rata_produksi_bulan : ' - ' ?> Kg <sup class="text-danger">/<?= ($this->session->userdata('lang') == 'EN') ? 'Month' : 'Bulan' ?></sup></td>
                           </tr>
                        <?php endif; ?>
                        
                        <?php if($jejaring->menjual_produk): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Selling Products' : 'Menjual Produk' ?></th>
                        ...
                        <?php if($jejaring->produk_dijual_bulanan): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Products Sold' : 'Produk Dijual' ?></th>
                              <td class="p-3"><?= ($jejaring->produk_dijual_bulanan) ? $jejaring->produk_dijual_bulanan : ' - ' ?> Kg <sup class="text-danger">/<?= ($this->session->userdata('lang') == 'EN') ? 'Month' : 'Bulan' ?></sup></td>
                           </tr>
                        <?php endif; ?>
                        
                        <?php if($jejaring->membutuhkan_produk): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Need Product' : 'Membutuhkan Produk' ?></th>
                        ...
                        <?php if($jejaring->produk_dibutuhkan_bulanan): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Products Required' : 'Produk Dibutuhkan' ?></th>
                              <td class="p-3"><?= ($jejaring->produk_dibutuhkan_bulanan) ? $jejaring->produk_dibutuhkan_bulanan : ' - ' ?> Kg <sup class="text-danger">/<?= ($this->session->userdata('lang') == 'EN') ? 'Month' : 'Bulan' ?></sup></td>
                           </tr>
                        <?php endif; ?>
                     </tbody>
                  </table>
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               <div class="box-title border-bottom p-3">
                  <h6 class="m-0 font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'Processed Foodstuff' : 'Olahan' ?></h6>
               </div>
               <div class="box-body">
                  <table class="table table-borderless mb-0">
                     <tbody>
                        <?php if($kategori_olahan->num_rows() > 0): ?>
                           <tr class="border-bottom">
                              <th class="p-3" width="40%;"><?= ($this->session->userdata('lang') == 'EN') ? 'Category' : 'Kategori' ?></th>
                              <td class="p-3"><?php 
                        ...
                        <?php if($jejaring->jenis_olahan): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Type' : 'Jenis' ?></th>
                        ...
                        <?php if($jejaring->jenis_pupuk): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Fertilizer' : 'Pupuk' ?></th>
                        ...
                        <?php if($jejaring->jenis_pestisida): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Pesticide' : 'Pestisida' ?></th>
                        ...
                        <?php if($jejaring->jenis_aisintan): ?>
                           <tr class="border-bottom">
                              <th class="p-3"><?= ($this->session->userdata('lang') == 'EN') ? 'Agricultural Machinery' : 'Alsintan' ?></th>
         ...
         <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
            <div class="box mb-3 shadow-sm rounded border-dark bg-white profile-box text-center">
               <div class="px-3 py-3">
                  <span class="badge badge-warning mb-3 w-100 py-1 text-uppercase"><?= ($this->session->userdata('lang') == 'EN') ? $jejaring->role_en : $jejaring->role ?></span>
                  <?php if($jejaring->img): ?>
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               <div class="box-title border-bottom p-3 d-flex align-items-center">
                  <h6 class="m-0"><?= ($this->session->userdata('lang') == 'EN') ? 'Gallery' : 'Galleri' ?></h6>
               ...
               <div class="box-body p-3">
                  <p class="mb-2 font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'Front View' : 'Tampak Depan'  ?></p>
                     <?php if($jejaring->cover_img): ?>
                     ...
                     <?php endif; ?>
                  <p class="mt-2 mb-2 font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'More Photos' : 'Foto Lainnya' ?></p>
         ...
         <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               <div class="box-title border-bottom p-3">
                  <h6 class="m-0"><?= ($this->session->userdata('lang') == 'EN') ? 'Other Data' : 'Data Lainnya' ?></h6>
               </div>
               <div class="box-body">
                  <div class="linked-accounts px-3 py-2 border-bottom">
                     <h6 class="font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'Selling' : 'Penjualan' ?></h6>
                     <ul>
                        <?php 
                  ...
                  <div class="linked-accounts px-3 py-2">
                     <h6 class="font-weight-bold"><?= ($this->session->userdata('lang') == 'EN') ? 'Interested' : 'Tertarik' ?></h6>
                     <ul>
                        <?php 
            ...
            <div class="box shadow-sm rounded bg-white mb-3">
               <div class="box-title border-bottom p-3 d-flex align-items-center">
                  <h6 class="m-0"><?= ($this->session->userdata('lang') == 'EN') ? 'Tani Class' : 'Kelas Tani' ?></h6>
                  <a class="ml-auto text-info" href="#"><?= ($this->session->userdata('lang') == 'EN') ? 'Read More' : 'Selengkapnya'  ?> <i class="fa fa-arrow-right ml-2"></i></a>
               </div>
               <a href="#">
