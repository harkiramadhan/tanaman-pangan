               ...
               <div class="col-lg-8 left">
                  ...
                  <div id="overview" class="seller-overview d-flex align-items-center">
                     <div class="user-profile-image d-flex">
                        ...
                        <img
                           src="<?= base_url() ?>assets/images/user/s2.png"
                  ...
                  <div class="slider mt-4">
                     <div id="aniimated-thumbnials" class="slider-for slick-slider-single">
                        ...
                        <img class="img-fluid" src="<?= base_url() ?>assets/images/list/v1.png" />
                        </a>
                        <a href="<?= base_url() ?>assets/images/list/v2.png">
                        <img class="img-fluid" src="<?= base_url() ?>assets/images/list/v2.png" />
                        </a>
                        <a href="<?= base_url() ?>assets/images/list/v3.png">
                        <img class="img-fluid" src="<?= base_url() ?>assets/images/list/v3.png" />
                        </a>
                        <a href="<?= base_url() ?>assets/images/list/v4.png">
                        <img class="img-fluid" src="<?= base_url() ?>assets/images/list/v4.png" />
                        </a>
                        <a href="<?= base_url() ?>assets/images/list/v5.png">
                        <img class="img-fluid" src="<?= base_url() ?>assets/images/list/v5.png" />
                        </a>
                     </div>
                              ...
                              <div class="inner-slider">
                                 <div class="inner-wrapper">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <img class="img-fluid"
                                          src="<?= base_url() ?>assets/images/user/s1.png"
                                          alt='' />
                                       </span>
                              ...
                              <div class="inner-slider">
                                 <div class="inner-wrapper">
                                    <div class="d-flex align-items-center">
                                       <span class="seller-image">
                                       <img class="img-fluid"
                                          src="<?= base_url() ?>assets/images/user/s3.png"
                                          alt='' />
                                       </span>
                                       <span class="seller-name">
                                       <a href="profile.html">Marcin Kowalski</a>
                        ...
                        <li>
                           <div class="d-flex">
                              <div class="left">
                                 <span>
                                 <img
                                    src="<?= base_url() ?>assets/images/user/s5.png"
                                    class="profile-pict-img img-fluid" alt="">
                                 </span>
                              </div>
                              <div class="right">
                                 ...
                                 <div class="country d-flex align-items-center">
                                    ...
                                    <img class="country-flag img-fluid"
                                       src="<?= base_url() ?>assets/images/flag/india.png">
                                    </span>
                     ...
                     <div class="inner-slider">
                        <div class="inner-wrapper">
                           <div class="d-flex align-items-center">
                              <span class="seller-image">
                              <img class="img-fluid"
                                 src="<?= base_url() ?>assets/images/user/s4.png"
                                 alt='' />
                              </span>
                              <span class="seller-name">
                              <a href="profile.html">Marcin Kowalski</a>
