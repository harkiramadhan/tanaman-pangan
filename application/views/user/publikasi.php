                           ...
                           <div class="filters-card-body card-shop-filters">
                              <?php foreach($kategori->result() as $kt){ ?>
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="ids[]" class="custom-control-input" id="cb<?= $kt->id ?>" value="<?= $kt->id ?>" <?= ($this->input->get('ids['.$kt->id.']', TRUE) == $kt->id) ? 'checked' : ''  ?>>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="sorting-div d-flex align-items-center justify-content-between">
                     <p class="mb-2"><?= $total ?> Publikasi Tersedia</p>
                     <div class="sorting d-flex align-items-center">
                        <p>Tampilkan</p>
                        <select class="custom-select custom-select-sm border-0 shadow-sm ml-2" id="order">
                           <option <?= ($this->input->get('order', TRUE) == 'Terbaru') ? 'selected' : '' ?> value="Terbaru"> Terbaru</option>
                           <option <?= ($this->input->get('order', TRUE) == 'A-Z') ? 'selected' : '' ?> value="A-Z"> A-Z</option>
                        </select>
                     </div>
                  </div>
